...
@time results_pairs = pairwise_comparisons(ids, step = 0.01) # 11s
...
@time results_pairs_fine = pairwise_comparisons(ids, step = 0.00001, save_all = false)
@time results_simul = simultaneous_comparisons(ids, step = 0.0001)
