...
# TODO: implement multiple solutions option
...
can1990_deu1990_replication = replicate_intensities(
    results_pairs, "can1990", "deu1990", x -> x in 0.62:0.01:0.7)
...
replicate_intensities(results_pairs, "deu1978", "deu1990",
    x -> x in [
        0.0, 0.01, 0.02, 0.08, 0.25, 0.29, 0.3, 0.37, 0.38, 0.39, 0.4, 0.41, 0.42, 0.49]
)
